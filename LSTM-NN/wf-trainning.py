...
print ("parameters for training: ",event_prefix,output_prefix,input_for_trainning,modelF,lossF,NN)

diraux, filename = os.path.split(output_prefix)
...
execline="python lstm-NN-cell-unrolled.py " + input_for_trainning + " " + modelF + " " + lossF + " " + str(NN)
os.system(execline)
