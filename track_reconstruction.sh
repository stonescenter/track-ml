...
time python ~/git/track-ml-1/lstm-map-demo-div-v2-inf.py ~/input_files_for_track/pt1p0_train_2_realv3_"$am"_`hostname` ~/input_files_for_track/train_2_"$am"_inferences_`hostname` ~/input_files_for_track/model_`hostname`.h5 ~/input_files_for_track/reconstructed_track_LSTM_`hostname`.csv 0
